 ...
 */
public class Ev extends JFrame
{
	...
	public void setbosskey(boolean bosskey) {
		this.bosskey=!this.bosskey;
	}
	...
	public void setmailkey(boolean mailkey) {
		this.mailkey=!this.mailkey;
	}
	public boolean getmailkey() {
		return mailkey;
	}
	public void sethrkey(boolean hrkey) {
		this.hrkey=!this.hrkey; 
	}
	public boolean gethrkey() {
		return hrkey;
	}
	...
	public void setserverkey(boolean serverkey) {
		this.serverkey=!this.serverkey;
	}
	public boolean getserverkey() {
		return serverkey;
	}
	 ...
	 */
	public Evan(int xsize, int ysize)
	{
		super();
		cp = new MyJPanel();
	...
	public boolean equals(Object other)
	{
		...
		if ( ! (other instanceof Evan) )
		{
			return false;
		}

		otherFace = (Evan) other;
...
class MyJPanel extends JPanel{
	...
	public void paint(Graphics g)
	{
		...
		else if (expression.equals("pissed off"))
		{
			g.drawLine(bounds.x + eyewidth, bounds.y + eyeheight/2, bounds.x + 2*eyewidth, bounds.y + eyeheight - 2);
			g.drawLine(bounds.x + 3*eyewidth, bounds.y + eyeheight - 2, bounds.x + 4*eyewidth, bounds.y + eyeheight/2);			g.drawArc(bounds.x + eyewidth, bounds.y + 3*eyeheight, 3*eyewidth, eyeheight, 0, 180);
			g.drawString("FUCK", bounds.x + 2*eyewidth, bounds.y + 4*eyeheight);
		}
		else
		{
			g.drawLine(bounds.x + eyewidth, bounds.y + eyeheight - 2, bounds.x + 2*eyewidth, bounds.y + eyeheight/2);
